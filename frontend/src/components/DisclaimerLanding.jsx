...
function DisclaimerLanding() {
    return (
        <div className="flex flex-row w-full rounded-full px-4 py-2 bg-black/20 justify-between items-center text-xs text-slate-600 dark:text-zinc-400">
            ...
            <div className="text-xs w-5/10 text-white text-center dark:text-zinc-400 border-r-2 border-l-2 pl-4 border-white dark:border-zinc-400 pr-4">
                ⚠️ Juego Responsable
            </div>
            <div className="text-xs w-3/10 text-white text-center dark:text-zinc-400 pl-4">
                📄 Se aplican TyC.</div>
        </div>
    );
}
