...
# Media / Storage (Cloudflare R2 & AWS S3 compatible)
...
AWS_S3_REGION_NAME = (
    os.getenv("R2_REGION_NAME", "auto")
    if R2_ACCOUNT_ID
    else os.getenv("AWS_S3_REGION_NAME", "auto")
)
...
AWS_PUBLIC_STORAGE_BUCKET_NAME = (
    os.getenv("R2_PUBLIC_BUCKET_NAME")
    or os.getenv("AWS_PUBLIC_STORAGE_BUCKET_NAME")
    or AWS_STORAGE_BUCKET_NAME
)
AWS_PRIVATE_STORAGE_BUCKET_NAME = (
    os.getenv("R2_PRIVATE_BUCKET_NAME")
    or os.getenv("AWS_PRIVATE_STORAGE_BUCKET_NAME")
    or AWS_STORAGE_BUCKET_NAME
)
AWS_PUBLIC_S3_REGION_NAME = os.getenv("R2_PUBLIC_REGION_NAME") or AWS_S3_REGION_NAME
AWS_PRIVATE_S3_REGION_NAME = os.getenv("R2_PRIVATE_REGION_NAME") or AWS_S3_REGION_NAME
AWS_PUBLIC_S3_ENDPOINT_URL = os.getenv("R2_PUBLIC_ENDPOINT_URL") or os.getenv("AWS_PUBLIC_S3_ENDPOINT_URL") or AWS_S3_ENDPOINT_URL
AWS_PRIVATE_S3_ENDPOINT_URL = os.getenv("R2_PRIVATE_ENDPOINT_URL") or os.getenv("AWS_PRIVATE_S3_ENDPOINT_URL") or AWS_S3_ENDPOINT_URL
AWS_PUBLIC_S3_CUSTOM_DOMAIN = (
    os.getenv("R2_PUBLIC_CUSTOM_DOMAIN")
    or os.getenv("AWS_PUBLIC_S3_CUSTOM_DOMAIN")
    or AWS_S3_CUSTOM_DOMAIN
)
AWS_PRIVATE_S3_CUSTOM_DOMAIN = os.getenv("R2_PRIVATE_CUSTOM_DOMAIN") or os.getenv("AWS_PRIVATE_S3_CUSTOM_DOMAIN")

# R2 and modern S3 require s3v4 signature and path-style addressing
...
if AWS_STORAGE_BUCKET_NAME or AWS_PUBLIC_STORAGE_BUCKET_NAME:
    STORAGES["default"] = {
