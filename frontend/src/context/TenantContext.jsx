...
export function TenantProvider({ children }) {
  ...
  const [tenantId, setTenantIdState] = useState(() => {
    ...
    if (isSuperuser(current)) return getActiveTenantId() || getUserEmpresa(current);
  ...
  const value = useMemo(
    ...
    [tenantId, tenantOptions, loading, isUserSuperuser, setTenantId]
  );
